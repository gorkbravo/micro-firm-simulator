...
- `index.html`: standalone simulator. Open it in a browser to run the classroom activity.
...
The simulator rounds follow the chronological order of the course:
